  ...
  return (
    <header
      className={`sticky top-0 z-40 border-b transition-colors duration-500 ease-[cubic-bezier(.16,1,.3,1)] ${
        surface
          ? "border-line bg-[color-mix(in_srgb,var(--color-ink)_92%,transparent)] backdrop-blur-md"
    ...
    >
      ...
      >
        <div className="overflow-hidden border-t border-line bg-[color-mix(in_srgb,var(--color-ink)_96%,transparent)] backdrop-blur-md">
          <nav
            aria-label="Primary"
